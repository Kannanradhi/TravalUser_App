...
public class SessionManager {
    ...
    private static final Type LIST_TYPE = new TypeToken<List<EmergencyPojo>>() {
    }.getType();
    ...
    public HashMap<String, String> getDriverStatus() {
        HashMap<String, String> code = new HashMap<String, String>();
        code.put(KEY_DRIVERSTATUS, pref.getString(KEY_DRIVERSTATUS, ""));
        return code;
    }

    public void setDriverStatus(String driverStatus) {
        editor.putString(KEY_DRIVERSTATUS, driverStatus);
        editor.commit();
    }
    ...
    public HashMap<String, String> getrideStatus() {
        HashMap<String, String> code = new HashMap<String, String>();
        code.put(KEY_RIDE_STATUS, pref.getString(KEY_RIDE_STATUS, ""));
        return code;
    }

    public void setrideStatus(String rideStatus) {
        editor.putString(KEY_RIDE_STATUS, rideStatus);
        editor.commit();
    }
    ...
    public Double getLatitude() {
        ...
        Toast.makeText(_context,"Latitude:"+getlati,Toast.LENGTH_SHORT).show();
    ...
    public Double getLongitude() {
        ...
        Toast.makeText(_context,"Longitude:"+getlati,Toast.LENGTH_SHORT).show();
        if (getlati.equalsIgnoreCase("")) {
            value = 0.0;
        } else {
            value = Double.parseDouble(getlati);
