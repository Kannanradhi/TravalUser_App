...
public class Fragment_HomePage_New extends Fragment implements GoogleApiClient.ConnectionCallbacks,
...
//            view.setAnimation(fadeInAnimation);
    ...
    private void select_carType_Dialog() {
        ...
        dialog.setPositiveButton(getActivity().getResources().getString(R.string.car_type_select_dialog_label_cancel), new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                    ...
                    if (object.length() > 0) {
                        if (object.getString("status").equalsIgnoreCase("1")) {
                            ...
                            if (jobject.length() > 0) {
                                ...
                                gender_preference_status = jobject.getString("gender_preference");
                                ...
                                } else if (genderSelected.equalsIgnoreCase("male")) {
                    ...
                    if (object.length() > 0) {
                        ...
                        if (status.equalsIgnoreCase("1")) {
                            ...
                            if (Sacceptance.equalsIgnoreCase("No")) {
                                ...
                                mDialog.setPositiveButton(getResources().getString(R.string.estimate_detail_label_ok), new OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        mDialog.dismiss();
...
//            genderIv.setImageDrawable(getResources().getDrawable(R.drawable.ic_gender_male));
//            wallet_radio_btn.setText(getResources().getText(R.string.gender_method_dialog_wallet_radio_label)+"("+strWalletAmount+")");
        } else {
