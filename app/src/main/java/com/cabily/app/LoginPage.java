...
import com.cabily.DataBase.DataBaseHelper;
import com.cabily.DataBase.DataBasePojo;
...
public class LoginPage extends Activity {
    ...
    private void initialize() {
        ...
        List<DataBasePojo> listDataBase = new ArrayList<>();
        listDataBase = dataBaseHelper.getJson();
        int count=dataBaseHelper.getJsonCount("AppInfo");
        Log.d("DataBase", listDataBase.get(0).getJson());
