 ...
 */
public class FavLocationSearch extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                cd = new ConnectionDetector(FavLocationSearch.this);
        ...
        et_search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (isInternetPresent) {
                    ...
                    String data =  et_search.getText().toString().toLowerCase().replace("%","").replace(" ","%20").trim();

                    CitySearchRequest(Iconstant.place_search_url +data+"&radius=500&location="+near_latitude+","+near_longitude);
                } else {
                    alert_layout.setVisibility(View.VISIBLE);
                    alert_textview.setText(getResources().getString(R.string.alert_nointernet));
                }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FavLocationSearch.this.finish();
                FavLocationSearch.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
            }
        });
    ...
    private void Alert(String title, String alert) {
        ...
        final PkDialog mDialog = new PkDialog(FavLocationSearch.this);
    ...
    private void CitySearchRequest(String Url) {
        ...
        mRequest = new ServiceRequest(FavLocationSearch.this);
        mRequest.makeServiceRequest(Url, Request.Method.GET, null, new ServiceRequest.ServiceListener() {
            ...
            public void onCompleteListener(String response) {
                ...
                adapter = new PlaceSearchAdapter(FavLocationSearch.this, itemList_location);
    ...
    private void LatLongRequest(String Url) {
        ...
        dialog = new Dialog(FavLocationSearch.this);
        dialog.getWindow();
