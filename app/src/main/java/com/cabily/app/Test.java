...
public class Test extends FragmentActivity {
    ...
    public static Test myrideDetail_class;
    ...
    private TextView Tv_rideID,Tv_rideAmount,Tv_carType,Tv_pickup_loc,Tv_drop_loc,Tv_pickup_time,Tv_drop_time,Tv_rideDistance,Tv_timeTaken,Tv_waitTime,
...
//        ChatService.startUserAction(MyRidesDetail.this);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("push".equalsIgnoreCase(sType)) {
                    Intent i = new Intent(Test.this, NavigationDrawer.class);
                    startActivity(i);
                } else {
                    onBackPressed();
                }
        ...
        Ll_cancelTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final PkDialog mDialog = new PkDialog(Test.this);
                ...
                mDialog.setPositiveButton(getResources().getString(R.string.my_rides_detail_cancel_ride_alert_yes), new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mDialog.dismiss();
                        cd = new ConnectionDetector(Test.this);
        ...
        Ll_payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInternetPresent) {
                    finish();
                    Intent passIntent = new Intent(Test.this, FareBreakUp.class);
                    passIntent.putExtra("RideID", SrideId_intent);
                    startActivity(passIntent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else {
        ...
        Ll_trackRide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInternetPresent) {
                    ...
                    Intent i = new Intent(Test.this, MyRideDetailTrackRide.class);
    ...
    private void initialize() {
        ...
        appInfo_Session = new AppInfoSessionManager(Test.this);
        cd = new ConnectionDetector(Test.this);
        isInternetPresent = cd.isConnectingToInternet();
    ...
    private void shareTrip() {
        completejob_dialog = new MaterialDialog(Test.this);
        View view = LayoutInflater.from(Test.this).inflate(R.layout.share_trip_popup, null);
        ...
        Bt_Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isValidPhoneNumber(Et_share_trip_mobileno.getText().toString())) {
                    ...
                    if (isInternetPresent) {
                        share_trip_postRequest_MyRides(Test.this, Iconstant.share_trip_url, "jobcomplete");
                    } else {
                        Alert(getResources().getString(R.string.alert_label_title), getResources().getString(R.string.alert_nointernet));
                    }
                }
    ...
    private void erroredit(EditText editname, String msg) {
        Animation shake = AnimationUtils.loadAnimation(Test.this, R.anim.shake);
    ...
    protected void sendEmail() {
        ...
        try {
            ...
            Toast.makeText(Test.this, getResources().getString(R.string.myrides_toast_there_is_no), Toast.LENGTH_SHORT).show();
        }
    }

    //----------Method for Invoice Email--------
    private void mailInvoice() {
        final View view = View.inflate(Test.this, R.layout.mail_invoice_dialog, null);
        invoice_dialog = new MaterialDialog(Test.this);
    ...
    private void panic() {
        ...
        View view = View.inflate(Test.this, R.layout.panic_page, null);
        final MaterialDialog dialog = new MaterialDialog(Test.this);
        ...
        EmergencyContactAdapter emergencyContactAdapter = new EmergencyContactAdapter(Test.this, emergencyList);
    ...
    private void favouriteAddress() {
        final View view = View.inflate(Test.this, R.layout.myride_detail_favourite_dialog, null);
        favourite_dialog = new MaterialDialog(Test.this);
    ...
    private void postRequest_MyRides(String Url) {
        ...
        mRequest = new ServiceRequest(Test.this);
                        ...
                        if (itemlist.size() > 0) {
                            ...
                            if (isPickUpAvailable) {
                                ...
                                if (!"".equalsIgnoreCase(sInvoiceSrc) && sInvoiceSrc != null) {
                                    ...
                                    Picasso.with(Test.this).load(sInvoiceSrc).placeholder(R.drawable.no_user_image).into(Iv_routeMap);
                                } else {
                            ...
                            if (itemlist.get(0).getRideStatus().equalsIgnoreCase("Completed") || itemlist.get(0).getRideStatus().equalsIgnoreCase("Finished")) {
                                ...
                                if (isFareAvailable) {
                                    ...
                                    FareAdaptewr adaptewr = new FareAdaptewr(Test.this, farelist);
            ...
            public void onCompleteListener(String response) {
                ...
                try {
                    ...
                    if (Sstatus.equalsIgnoreCase("1") && isReasonAvailable) {
                        Intent passIntent = new Intent(Test.this, MyRideCancelTrip.class);
